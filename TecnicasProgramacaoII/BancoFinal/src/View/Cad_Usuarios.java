...
public class Cad_Usuarios extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (operacaoAtivaGlobal.equals(operacao)) {
            tela_usu.setSenha(Arrays.toString(jPasswordField1.getPassword()));
            tela_usu.setNum_AGE(Integer.parseInt(jTextField3.getText()));
            tela_usu.setNum_CC(Integer.parseInt(jTextField4.getText()));
            
            ConnectDAO objcon = new ConnectDAO();
            objcon.insereRegistroJFBD("USUARIOS", tela_usu.dadosSQLValues());
            
            jTextField3.setText(String.valueOf(tela_usu.getNum_AGE()));
            jTextField4.setText(String.valueOf(tela_usu.getNum_CC()));
            jPasswordField1.setText(tela_usu.getSenha());
        }
