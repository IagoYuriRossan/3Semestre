...
public class Cad_Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("ID do Cliente");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (operacaoAtivaGlobal.equals(operacao)) {
            clientes_tela.setNome(jTextField1.getText());
            clientes_tela.setCPF(jTextField4.getText());
            clientes_tela.setEndereco(jTextField2.getText());
            clientes_tela.setNumero(jTextField6.getText());
            clientes_tela.setComplemento(jTextField9.getText());
            clientes_tela.setBairro(jTextField3.getText());
            clientes_tela.setCidade(jTextField5.getText());
            clientes_tela.setCep(jTextField8.getText());
